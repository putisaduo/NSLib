#include "StdHeader.h"
#ifndef _NSLib_document_Field_
#define _NSLib_document_Field_
...
public:
  ...
  Field(const char_t* Name, util::BasicReader* reader, bool store, bool index, bool token);
  Field(const char_t* Name, util::BasicReader* reader);
  ...
  //  "body".
  static Field& Text(char_t* Name, util::BasicReader* Value);
